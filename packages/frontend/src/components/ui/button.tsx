...
const styles = {
  base: [
    ...
    // Focus
    "focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-[#135394]",
    // Disabled
  ...
  colors: {
    ...
    blue: [
      "text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:#135394] [--btn-border:#0f427a]/90",
      "[--btn-icon:#5B8FB9] data-active:[--btn-icon:#7BA7CD] data-hover:[--btn-icon:#7BA7CD]",
    ],
    violet: [
